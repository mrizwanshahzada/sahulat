...
@section("content")
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper">
                        <h2 class="product-title">Renew Subscription</h2>
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="ti-home"></i> Home</a></li>
                            <li class="current">Renew Subscription</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="container subscription-form-container">
                    ...
                    <div class="job-list-content" style="width: 100%; margin: 0;">
                        ...
                        <div class="job-tag">
                            ...
                            <div class="pull-right">
                                <div class="meta-tag">
                                    <span><i class="ti-time"></i>Your Current Subscription Is Expiring On {{ Carbon\Carbon::now()->addDays(5)->format('d M Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <br>
                <button class="btn btn-success subscribe-button" id="subscribe-button">Renew Subscription</button>
            </div>
        </div>
    </div>
    </div>
...
@section('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        subscribeButton.addEventListener('click', function(ev) {
            ...
            var tasks = ($('#duration').val() / '{{ $subscription->frequency }}');
