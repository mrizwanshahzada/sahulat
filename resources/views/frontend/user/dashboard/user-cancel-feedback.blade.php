...
<center>
        <form method="POST" action="{{route('cancelNotify',$task)}}">

    <h3 class="rating margn">Please share your feedback about </h3>

            @csrf
     
          <div class="form-group" class="">
            <label for="exampleInputPassword1">Give commnets</label>
            <textarea  class="form-control" name="comments" id="" placeholder="comments">
            </textarea>
