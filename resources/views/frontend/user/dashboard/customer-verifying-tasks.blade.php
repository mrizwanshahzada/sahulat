    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Verify Tasks</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div id="content">
               <div class="container applications-content">
                 @if(count($tasks)>0)
                    ...
                    <tbody>
                      @foreach ($tasks as $task)
                        ...
                        <tr>
                          ...
                          <td>{{ $task->status }}</td>
                          <td>
                            <a href="{{route('userRejectTask',$task)}}" class="btn btn-danger btn-sm">Cancel</a>
                            <a href="{{route('userRatingTask',$task)}}" class="btn btn-warning btn-sm">Done</a>
                          </td>
                        </tr>
                  ...
                  @endif
                @if(count($tasks)<=0)
                   <div> <h5>You have not verifiying task</h5></div>
                @endif
               </div>
            </div>
        </section>
